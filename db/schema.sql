...
--
-- Жодного DROP тут немає навмисно. На вже заповненій базі цей файл має впасти
-- на «relation already exists», а не мовчки знести чужі дані. Перезалити базу
-- можна рівно однією явною командою — `psql -f db/reset.sql`, і це єдиний
-- файл у db/, який щось знищує.
